...
class SamImageProcessor(BaseImageProcessor):
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        '''
        https://huggingface.co/docs/transformers/main/en/main_classes/image_processor#transformers.BatchFeature
        BatchFeature 
        This class is derived from a python dictionary 
        and can be used as a dictionary.

        如果tensor_type=None ,return self

        self 就是data 
        虽然是个transformers.image_processing_utils.BatchFeature的class
        但是可以当作dic用，
        BatchFeature["pixel_values"] 就是 images
        '''
