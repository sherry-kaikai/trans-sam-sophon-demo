...
class SamProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        SamImageProcessor.__call__继承了BaseImageProcessor.__call__ 。
        BaseImageProcessor.__call__返回了self.preprocess(images, return_tensors,**kwargs)
        这里的self.preprocess(images, **kwargs)返回了SamImageProcessor.preprocess
